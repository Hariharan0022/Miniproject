...
const AddShowForm = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await axios.put('http://127.0.0.1:8081/put', formData, {
          headers: {
  ...
  return (
    <div className='addcrud'>
      <h1 className='arh1'>Update Employee</h1>
      <form className="arform"onSubmit={handleSubmit}>
        ...
        <center><button className="arsubmit"type="submit">Update</button></center>
      </form>
